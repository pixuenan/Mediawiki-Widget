...
div_content.push('<a href="http://factpub.org/wiki/index.php?search=autism">Facts about Autism</a>');
...
div_content.push('<div class="row col-md-10 col-md-offset-4">');
div_content.push('<div class="col-xs-12">');
div_content.push('<a href="http://factpub.org/wiki/index.php?search=ecstasy">Facts about Ecstacy</a>');
div_content.push('</div>');
div_content.push('</div>');
div_content.push('</div>');   
div_content.push('</div>'); 
...
div_content.push('<div class="row col-md-10 col-md-offset-4">');
div_content.push('<div class="col-xs-12">');
div_content.push('<a href="http://factpub.org/wiki/index.php?search=depression">Facts about Depression</a>');
div_content.push('</div>');
div_content.push('</div>');
div_content.push('</div>');      
div_content.push('</div>');
...
div_content.push('<div class="row col-md-10 col-md-offset-4">');
div_content.push('<div class="col-xs-12">');
div_content.push('<a href="http://factpub.org/wiki/index.php?search=heroin">Facts about Heroin</a>');
div_content.push('</div>');
div_content.push('</div>');
div_content.push('</div>');   
div_content.push('</div>'); 
